...
public final class StringUtil
{
	...
	/**
	 * Try to detect the enconding text
	 * 
	 * @param text
	 * @return
	 */
	public static String detectEncodingType(String text)
	{
		...
		{
			for (int j = 0; j < codings.length; j++)
			{
				try
				{
					String coding = codings[j];
					String cChar = new String(chars[i].getBytes(), coding);
					if (text.contains(cChar))
						return coding;
				}
